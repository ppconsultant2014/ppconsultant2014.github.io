		...
		<div class="col-lg-4 col-md-4 col-sm-6 padbot30">
			...
			<ul>
				...
				<div class="col-lg-4 col-md-4 col-sm-6 padbot30 foot_about_block">
					...
					<ul class="social">
						<li><a href="javascript:void(0);" ><i class="glyphicon glyphicon-twitter"></i></a></li>
						<li><a href="javascript:void(0);" ><i class="glyphicon glyphicon-facebook"></i></a></li>
						<li><a href="javascript:void(0);" ><i class="glyphicon glyphicon-google-plus"></i></a></li>
						<li><a href="javascript:void(0);" ><i class="glyphicon glyphicon-pinterest-square"></i></a></li>
						<li><a href="javascript:void(0);" ><i class="map_show glyphicon glyphicon-map-marker"></i></a></li>
					</ul>
				</div>
			...
			<p align="center"> Copyright &copy; <?php echo date('Y');?> Product procurement consultant Ltd. All rights reserved
			</p>
		</div><!-- //CONTAINER -->
	</footer><!-- //FOOTER -->
